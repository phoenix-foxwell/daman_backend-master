...
router.post("/admin/get_user_from_card", UsersController.get_user_from_card);
...
router.post("/admin/register_login_nonmember", UsersController.register_login_nonmember);
